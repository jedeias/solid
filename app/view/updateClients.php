...
require_once ("../autoload.php");
    ...
    $innerJoinsClients = new InnerJoinsClients();  
...
<ul class="menu">
    ...
    <div class="form-group">
        ...
        <input type="text" <?php echo "value={$services['value_cost']}";?> name="cost" class="form-control" id="inputAddress">
    </div>
    <div class="form-group">
        <label for="inputAddress2">services</label>
        <input type="text" name='services' <?php echo "value={$services['services']}";?> class="form-control" id="inputAddress2">
    </div>
