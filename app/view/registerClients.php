...
require_once ("../autoload.php");
    ...
    if($_POST != null){
        ...
        $client = new Clients($person, $_POST['services'], $_POST['cost']);
...
<ul class="menu">
    ...
    <div class="form-group">
        ...
        <input type="text" name="cost" class="form-control" id="inputAddress">
    </div>
    <div class="form-group">
        <label for="inputAddress2">services</label>
        <input type="text" name='services' class="form-control" id="inputAddress2">
    </div>
